//MODIFIED BY Trevor Colby:
//11-17-2018
//
//Modifications:
// - Added more usable key controls (changed arrow keys to wasd keys)
// - Removed click/single movement and modified logic to incorporate continuous motion on keypress
/**
...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.update = function (delta) {
		...
		return function update() {
			...
			//move into the normal orbital transformations
	...
	function handleKeyUp( event ) {
		...
		switch ( event.keyCode ) {
			...
			case 82: /*R*/ scopemoveUp = false; break;
